    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="therally.php">HOW IT WORKS</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="register.php">REGISTER</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="stages.php">LIST OF STAGES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="imrg.php">LIST OF IMRGS</a>
          </li>
		</ul>
		...
		<ul class="navbar-nav ml-auto my-2 my-lg-0">
		  ...
		  echo'<li class="nav-item align-middle"><a class="nav-link">Hello '.$_SESSION["prenom"].' '.$_SESSION["nom"].'</a>
          <a class="nav-link" href="changepass.php?user='.$_SESSION["email"].'">Change Password</a>
          
          </li>';
		  echo'<li class="nav-item bg-dark p-3"><a class="nav-link text-light" href="logout.php">LOG OUT</a></li>';
		  }
