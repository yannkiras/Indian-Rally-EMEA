...
<div class="bg-image p-4 rallybg">
    ...
    <div class="container">
        ...
        <div class="row mx-auto">
            ...
            <div class="col-6 col-lg-auto mx-auto border border-5 border-success"><a href="../AT/admin.php"><img src="../img/flag_at.png" class="img-fluid" style="max-width: 150px"></a></div>
