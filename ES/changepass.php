...
<HTML>
    <HEAD>
        ...
        <TITLE>Indian Motorcycle Rally - Change password</TITLE>
    </HEAD>
    <BODY>
                ...
                <?php
                    ...
                    if (isset($_POST['changepass'])) {
                        ...
                        if ($password != $passwordbis) {
                            echo "<div class='bg-primary text-white py-4'><h3><center><strong>Error: </strong> The passwords do not match.</center></h3></div>";
                            } else {
                        ...
                        if ($result) {
                            ...
                            session_destroy();
                            echo "<div class='bg-primary text-white py-4'><center><h3>Your password has been changed, please log in again.</center></h3></div>";
                            } else {
                            echo "<div class='bg-primary text-white py-4'><center><h3>An error occured. please try again later.</center></h3>" . mysqli_error($mysqli)."</div>";
                        }
                    }
                }
