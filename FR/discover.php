        ...
        <div class="row m-auto py-4">
            ...
            <div class="col-12 col-lg-8 bg-primary my-auto p-4">
                <center><h4 class="pb-4 text-white text-start">L&#39;INDIAN MOTORCYCLE RALLY EST UNE INVITATION AU
                        VOYAGE DANS LES RÉGIONS DE FRANCE.</center>

                </h4>
                <div class="row">
                    <div class="col-12 col-lg-6 fs-7 text-white text-start">
                        <p class="pb-2">■ AU COURS DE CHACUN DE VOS DÉPLACEMENTS, MARQUEZ UNE ÉTAPE CHEZ L’UN DES 33
                            CONCESSIONNAIRES
                    ...
                    <div class="col-12 col-lg-6 fs-7 text-start">
                        <p class="pb-2 text-white">CHACUN DES 3 PREMIERS DE CHAQUE CATÉGORIE AYANT COMPTABILISÉ LA PLUS
                            HAUTE MOYENNE
                        ...
                        <div class="card text-black bg-light mb-2" style="max-width: 100ev;">
                            <div class="card-body">
                                ...
                                <strong>■ 1ER : 600 € DE CHÈQUE CADEAU EN ÉQUIPEMENT ET ACCESSOIRES INDIAN
                                    MOTORCYCLE</strong><br>
                                <strong>■ 2ÈME : 400 € DE CHÈQUE CADEAU EN ÉQUIPEMENT ET ACCESSOIRES INDIAN
                                    MOTORCYCLE</strong><br>
                                <strong>■ 3ÈME : 250 € DE CHÈQUE CADEAU EN ÉQUIPEMENT ET ACCESSOIRES INDIAN
                                    MOTORCYCLE</strong><br>
