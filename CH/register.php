...
<div class="rallybg">
    ...
    if (isset($_POST['register'])) {
        ...
        if ($password != $passwordbis) {
            ...
            if ($user_matched > 0) {
                echo "<br/><br/><h3><center><strong>Erreur: </strong> Un utilisateur existe déjà pour l'adresse email '$email'.<br>Merci d'en utiliser une nouvelle.</center></h3>";
            } else {
    ...
    <FORM action="register.php" method="post" name="registerform" class="needs-validation">
        ...
        <CENTER>
            <br>En vous enregistrant, vous acceptez le traitement de vos données conformément à notre <a
                    href="https://www.polaris.com/en-us/privacy/" target="_blank" class="text-light">politique de confidentialité</a> <br>
...
<DIV class="container my-4 ̂py-4 text-white bg-primary text-white" style="max-width:600px;">
    <H4 class="py-2">VOUS ÊTES DEJA INSCRIT ?</H4>
    <CENTER>
