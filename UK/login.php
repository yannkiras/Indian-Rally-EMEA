...
<head>
    ...
    <title>Indian Motorcycle Rally - Log In</title>
</head>
    ...
    <div class="container py-4 bg-primary text-white" style="max-width:600px;">
        ...
        if (isset($_POST['login'])) {
            ...
            if ($user_matched > 0) {
                ...
                echo "<h3><center>Your username or password do not match.</center></h3>";
            }
        }
        ...
        <form action="login.php" method="post" name="form1" charset="UTF-8">
            ...
            <center>
                <button type="submit" id="login" name="login" class="btn btn-light btn-lg my-4">LOG IN</button>
            </center>
        </form>
        <br/>
        <a href="forget.php" class="text-white">Forgotten password? Please click here.</a>
    </div>
    <div class="container my-4 py-4 bg-primary text-white" style="max-width:600px;">
        <h4 class="py-2">NOT REGISTERED ?</h4>
        <center>
            <a class="btn btn-light btn-lg my-4" href="register.php" role="button">SIGN UP HERE.</a>
        </center>
    </div>
    <br>
</div>
