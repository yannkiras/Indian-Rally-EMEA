...
<head>
    ...
    <title>My Indian Motorcycle Rally</title>
</head>
...
<div class="bg-image p-4 rallybg">
    <div class="container">
        <h3>MY INDIAN MOTORCYCLE RALLY</h3>
        <br/>
        <h4>
            <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $etapes = $row['etapes'];
                if ($km > 0) {
                    echo $km . " MILES TRAVELLED THIS SEASON IN " . $etapes . " STAGES.";
                } else {
                    echo "YOU DID NOT VALIDATE A STAGE YET";
                }
            }
                ...
                <div class='modal-dialog modal-sm' role='document'>
                    <div class='modal-content'>
                        <div class='modal-header'>
                            <h5 class='modal-title text-primary' id='exampleModalLabel'>Change My Motorcycle</h5>
                        </div>
                            ...
                            <div class='modal-body text-primary fw-bold'>
                                <CENTER>
                                    ...
                                    <SELECT id="moto" name="moto" class="form-select" required>
                                        <OPTION disabled value="" selected hidden>Select your Motorcycle</OPTION>
    ...
    <a class="btn btn-primary text-light" href="Pass.pdf">DOWNLOAD MY PARTICIPANT PASS</a>
    <br>
    <br>
    ...
    <div class='row row-cols-1 row-cols-md-3'> <!-- BEGIN GRID -->
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "	
				...
				Starting City : " . $row['depart'] . " (" . $row['cp_depart'] . ")<br>
				Mileage completed : " . $row['km'] . " miles
				</p>
				</div>
				<div class='col-md-2'>
				<center>
				<!-- Button trigger modal delete-->
				<a href='#Delete" . $row['id_voyage'] . "' role='button' data-toggle='modal' data-bs-toggle='tooltip' data-bs-placement='top' title='Delete this stage'>
				<img src='img/rally_delete-icon.svg'class='img-fluid' style='max-width:50px;'></a>
				<!-- Button trigger modal modify-->
				<a href='#Modify" . $row['id_voyage'] . "' role='button' data-toggle='modal' data-bs-toggle='tooltip' data-bs-placement='top' title='Modify this step'>
				...
				<div class='modal-content'>
				<div class='modal-header'>
				<h5 class='modal-title text-primary' id='Modaldelete'>Delete the stage to " . $row['concess'] . " ?</h5>
				</div>
				<div class='modal-body text-primary fw-bold'>
				<CENTER>
				...
				<a class='btn btn-primary text-light' href='delete.php?id_voyage=" . $row['id_voyage'] . "'>YES</a>
				
				
				<button type='button' class='btn btn-primary text-light' data-dismiss='modal'>NO</button>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "	
				...
				<div class='modal-content'>
				<div class='modal-header'>
				<h5 class='modal-title text-primary' id='exampleModalLabel'>Validate the stage to " . $row['concess'] . "</h5>
				</div>
				<div class='modal-body text-primary fw-bold'>
				<CENTER>
				...
				<INPUT type='submit' id='ajouter' name='ajouter' class='btn btn-primary text-light btn-lg my-4' value='VALIDATE THIS STAGE'/>
				</FORM>
				</CENTER>
				</div>
				<div class='modal-footer'>
