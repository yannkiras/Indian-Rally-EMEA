...
<html>
    ...
    <body class="text-white">
        ...
        ?>
                ...
                <h5 class="py-2">VOUS ÉTIEZ INSCRIT EN 2021 ?</h4>
                ...
                <br/>
                <a href="forget.php" class="text-white">J'ai oublié mon mot de passe, je clique ici.</a>
            </div>
            <div class="container my-4 py-4 bg-primary text-white" style="max-width:600px;">
                <h4 class="py-2">VOUS N'ÊTES PAS INSCRIT ?</h4>
                <center>
